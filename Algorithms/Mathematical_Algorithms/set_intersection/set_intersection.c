...
void intersection_of_set(int set_one_size, int* set_one, int set_two_size, int* set_two)
{
	int i =0;
...
int main(void)
{
	...
	intersection_of_set(set_one_size, set_one, set_two_size, set_two);
	printf("\n Program to implement two set intersection operation of set theory:\n");
	return 0;
}
